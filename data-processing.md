...
![In the Document Term Matrix, each row represents a review, and each column represents a term. Each cell is equal to the number of occurrences of the term in the corresponding review.](https://github.com/cvint13/DSSG2016-UnsafeFoods/blob/gh-pages/assets/images/dtm_viz.PNG)
